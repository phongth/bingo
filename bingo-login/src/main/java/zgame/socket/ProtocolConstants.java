...
public interface ProtocolConstants {
  ...
  public interface RequestHeader {
    ...
    /**
     * GameService báo cho DefaultService khi có user authen thành công vào
     * GameService
     */
    ...
    int INVITE_USER_TO_GROUP_REQUEST = 201; // toUser + groupId (client
                                            // generate)
  ...
  public interface ResponseHeader {
    ...
    /**
     * Default Service báo về cho game Service là session theo username đã yêu
     * cầu không tồn tại
     */
    ...
    // *************** CHAT FUNCTION (200 ~ 220) ***********************
    int MESSAGE_RESPONSE = 200; // fromUser + fromGroup (if only fron User, then
                                // fromGroup = fromUser) + message
