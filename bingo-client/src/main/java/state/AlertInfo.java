...
public class AlertInfo {
	...
	public String toString() {
		return "AlertInfo [alertId=" + alertId + ", alertMessages="
				+ alertMessages + ", alertTimeOut=" + alertTimeOut
				+ ", alertType=" + alertType + ", alineType=" + alineType
				+ ", buttonLabels=" + ", buttonWidth=" + buttonWidth
				+ ", customUISprites=" + ", listenner=" + listenner + "]";
	}
