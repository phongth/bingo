...
public class FrmChess extends GameForm implements TimerListener,
		DataReceiveListener {
	...
	private void initChessBoard() {
		...
		int[][] upSide = new int[][] { { 0, 3 }, { 2, 3 }, { 4, 3 }, { 6, 3 },
				{ 8, 3 }, { 1, 2 }, { 7, 2 }, { 0, 0 }, { 8, 0 }, { 1, 0 },
				{ 7, 0 }, { 2, 0 }, { 6, 0 }, { 3, 0 }, { 5, 0 }, { 4, 0 } };
		int[][] downSide = new int[][] { { 0, 6 }, { 2, 6 }, { 4, 6 },
				{ 6, 6 }, { 8, 6 }, { 1, 7 }, { 7, 7 }, { 0, 9 }, { 8, 9 },
				{ 1, 9 }, { 7, 9 }, { 2, 9 }, { 6, 9 }, { 3, 9 }, { 5, 9 },
				{ 4, 9 } };
		int[][] redSide = null;
		int[][] blackSide = null;
		...
		currentSelectArea = new ChessMan(ChessMan.NO_SIDE,
				ChessMan.CHOOSE_AREA_TYPE, areaImage, 4, 7);
		currentSelectArea1 = new ChessMan(ChessMan.NO_SIDE,
				ChessMan.CHOOSE_AREA_TYPE, areaImage, 0, 0);
		...
		chessMans[ChessMan.RED_SIDE][0] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.TOT_TYPE, tmpImage, redSide[0][0], redSide[0][1]);
		chessMans[ChessMan.RED_SIDE][1] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.TOT_TYPE, tmpImage, redSide[1][0], redSide[1][1]);
		chessMans[ChessMan.RED_SIDE][2] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.TOT_TYPE, tmpImage, redSide[2][0], redSide[2][1]);
		chessMans[ChessMan.RED_SIDE][3] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.TOT_TYPE, tmpImage, redSide[3][0], redSide[3][1]);
		chessMans[ChessMan.RED_SIDE][4] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.TOT_TYPE, tmpImage, redSide[4][0], redSide[4][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 120, 29, 22, 22, true);
		chessMans[ChessMan.RED_SIDE][5] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.PHAO_TYPE, tmpImage, redSide[5][0], redSide[5][1]);
		chessMans[ChessMan.RED_SIDE][6] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.PHAO_TYPE, tmpImage, redSide[6][0], redSide[6][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 5, 29, 22, 22, true);
		chessMans[ChessMan.RED_SIDE][7] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.XE_TYPE, tmpImage, redSide[7][0], redSide[7][1]);
		chessMans[ChessMan.RED_SIDE][8] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.XE_TYPE, tmpImage, redSide[8][0], redSide[8][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 28, 29, 22, 22, true);
		chessMans[ChessMan.RED_SIDE][9] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.MA_TYPE, tmpImage, redSide[9][0], redSide[9][1]);
		chessMans[ChessMan.RED_SIDE][10] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.MA_TYPE, tmpImage, redSide[10][0], redSide[10][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 51, 29, 22, 22, true);
		chessMans[ChessMan.RED_SIDE][11] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.TUONG_TYPE, tmpImage, redSide[11][0], redSide[11][1]);
		chessMans[ChessMan.RED_SIDE][12] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.TUONG_TYPE, tmpImage, redSide[12][0], redSide[12][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 74, 29, 22, 22, true);
		chessMans[ChessMan.RED_SIDE][13] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.SY_TYPE, tmpImage, redSide[13][0], redSide[13][1]);
		chessMans[ChessMan.RED_SIDE][14] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.SY_TYPE, tmpImage, redSide[14][0], redSide[14][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 97, 29, 22, 22, true);
		chessMans[ChessMan.RED_SIDE][15] = new ChessMan(ChessMan.RED_SIDE,
				ChessMan.VUA_TYPE, tmpImage, redSide[15][0], redSide[15][1]);

		tmpImage = ImageUtil.getSubImage(chessMansImage, 144, 3, 22, 22, true);
		chessMans[ChessMan.BLACK_SIDE][0] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.TOT_TYPE, tmpImage, blackSide[0][0], blackSide[0][1]);
		chessMans[ChessMan.BLACK_SIDE][1] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.TOT_TYPE, tmpImage, blackSide[1][0], blackSide[1][1]);
		chessMans[ChessMan.BLACK_SIDE][2] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.TOT_TYPE, tmpImage, blackSide[2][0], blackSide[2][1]);
		chessMans[ChessMan.BLACK_SIDE][3] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.TOT_TYPE, tmpImage, blackSide[3][0], blackSide[3][1]);
		chessMans[ChessMan.BLACK_SIDE][4] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.TOT_TYPE, tmpImage, blackSide[4][0], blackSide[4][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 120, 3, 22, 22, true);
		chessMans[ChessMan.BLACK_SIDE][5] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.PHAO_TYPE, tmpImage, blackSide[5][0], blackSide[5][1]);
		chessMans[ChessMan.BLACK_SIDE][6] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.PHAO_TYPE, tmpImage, blackSide[6][0], blackSide[6][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 5, 3, 22, 22, true);
		chessMans[ChessMan.BLACK_SIDE][7] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.XE_TYPE, tmpImage, blackSide[7][0], blackSide[7][1]);
		chessMans[ChessMan.BLACK_SIDE][8] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.XE_TYPE, tmpImage, blackSide[8][0], blackSide[8][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 28, 3, 22, 22, true);
		chessMans[ChessMan.BLACK_SIDE][9] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.MA_TYPE, tmpImage, blackSide[9][0], blackSide[9][1]);
		chessMans[ChessMan.BLACK_SIDE][10] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.MA_TYPE, tmpImage, blackSide[10][0], blackSide[10][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 51, 3, 22, 22, true);
		chessMans[ChessMan.BLACK_SIDE][11] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.TUONG_TYPE, tmpImage, blackSide[11][0],
				blackSide[11][1]);
		chessMans[ChessMan.BLACK_SIDE][12] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.TUONG_TYPE, tmpImage, blackSide[12][0],
				blackSide[12][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 74, 3, 22, 22, true);
		chessMans[ChessMan.BLACK_SIDE][13] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.SY_TYPE, tmpImage, blackSide[13][0], blackSide[13][1]);
		chessMans[ChessMan.BLACK_SIDE][14] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.SY_TYPE, tmpImage, blackSide[14][0], blackSide[14][1]);
		tmpImage = ImageUtil.getSubImage(chessMansImage, 97, 3, 22, 22, true);
		chessMans[ChessMan.BLACK_SIDE][15] = new ChessMan(ChessMan.BLACK_SIDE,
				ChessMan.VUA_TYPE, tmpImage, blackSide[15][0], blackSide[15][1]);
		chessMansImage = null;
		...
		lastMoveSmallSprite = new ChessMan(ChessMan.NO_SIDE,
				ChessMan.CHOOSE_AREA_TYPE, lastMoveSmallImage, 4, 7);
		lastMoveSmallSprite.setVisible(false);
		lastMoveLargeSprite = new ChessMan(ChessMan.NO_SIDE,
				ChessMan.CHOOSE_AREA_TYPE, lastMoveLargeImage, 4, 7);
	...
	public void draw(Graphics g) {
		...
		for (int i = 0; i < chessMans.length; i++) {
			for (int j = 0; j < chessMans[i].length; j++) {
				...
				if ((chessMan != null) && chessMan.isVisible()) {
					g.drawImage(chessMan.getImage(), chessMan.getRealX(),
							chessMan.getRealY(), GameConstants.TOP_LEFT_ANCHOR);
				}
			}
		}
		...
		if ((lastMoveSmallSprite != null) && lastMoveSmallSprite.isVisible()) {
			g.drawImage(lastMoveSmallSprite.getImage(), lastMoveSmallSprite
					.getRealX(), lastMoveSmallSprite.getRealY(),
					GameConstants.TOP_LEFT_ANCHOR);
		}
		if ((lastMoveLargeSprite != null) && lastMoveLargeSprite.isVisible()) {
			g.drawImage(lastMoveLargeSprite.getImage(), lastMoveLargeSprite
					.getRealX(), lastMoveLargeSprite.getRealY(),
					GameConstants.TOP_LEFT_ANCHOR);
		}
		if ((currentSelectArea != null) && currentSelectArea.isVisible()) {
			g.drawImage(currentSelectArea.getImage(), currentSelectArea
					.getRealX(), currentSelectArea.getRealY(),
					GameConstants.TOP_LEFT_ANCHOR);
		}
		if ((currentSelectArea1 != null) && currentSelectArea1.isVisible()) {
			g.drawImage(currentSelectArea1.getImage(), currentSelectArea1
					.getRealX(), currentSelectArea1.getRealY(),
					GameConstants.TOP_LEFT_ANCHOR);
		}

		// Draw message chiếu tướng
		if (isChieuTuong) {
			text11.drawString(g, "Chiếu tướng", Color.BLACK_CODE,
					GameConstants.SCREEN_WIDTH / 2, 145,
	...
	public void keyReleased(int keyCode) {
		...
		case Key.FIRE:
		case Key.K_5:
			ChessMan selectedChessMan = getChessMan(mySide, currentSelectArea
