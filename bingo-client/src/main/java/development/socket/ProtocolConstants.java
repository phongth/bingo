...
public interface ProtocolConstants {
	...
	public interface ResponseHeader {
		...
		/**
		 * Default Service báo về cho game Service là session theo username đã
		...
		// *************** CHAT FUNCTION (200 ~ 220) ***********************
		int MESSAGE_RESPONSE = 200; // fromUser + fromGroup (if only fron User,
									// then fromGroup = fromUser) + message
