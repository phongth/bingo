...
public class FrmChangePassword extends GameForm {
  ...
  public void init(Hashtable parameters) {
    ...
    oldPasswordTextField = new TextField(TextField.CONSTRAINT_PASSWORD, Constants.TEXT_FIELD_STYLE);
    newPasswordTextField = new TextField(TextField.CONSTRAINT_PASSWORD, Constants.TEXT_FIELD_STYLE);
    newPasswordTextField1 = new TextField(TextField.CONSTRAINT_PASSWORD, Constants.TEXT_FIELD_STYLE);
  ...
  private void drawFor240x320(Graphics g) {
    ...
    text8.drawString(g, "MK cũ", Color.WHITE_CODE, 15, 160, GameConstants.TOP_LEFT_ANCHOR);
    oldPasswordTextField.draw(g);
    text8.drawString(g, "MK mới", Color.WHITE_CODE, 15, 190, GameConstants.TOP_LEFT_ANCHOR);
  ...
  private void drawFor320x240(Graphics g) {
    ...
    text8.drawString(g, "Mật khẩu cũ", Color.WHITE_CODE, 55, 126, GameConstants.TOP_LEFT_ANCHOR);
    oldPasswordTextField.draw(g);
    text8.drawString(g, "Mật khẩu mới", Color.WHITE_CODE, 55, 155, GameConstants.TOP_LEFT_ANCHOR);
    newPasswordTextField.draw(g);
  ...
  public void draw(Graphics g) {
    ...
    text8.drawString(g, "Thay đổi", Color.WHITE_CODE, GameConstants.SCREEN_WIDTH / 2, GameConstants.SCREEN_HEIGHT - 5, GameConstants.BOTTOM_HCENTER_ANCHOR);
  ...
  private void changePassword() {
    ...
    if (oldPassword.length() == 0) {
      GameGlobal.alert.showAlert(this, Alert.OK_TYPE, new String[] {"Bạn cần nhập vào mật khẩu cũ"});
      return;
    }
