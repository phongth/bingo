...
public class MemoryTrace {
	 ...
	 * 
	 * @param g - Graphic dùng để ghi log
	 * @param color - Mầu của text
	 */
	public static void trace(Graphics g, int color) {
        ...
        g.drawString(String.valueOf(total), 240, 10, GameConstants.TOP_RIGHT_ANCHOR);
        g.drawString("free:", 90, 30, GameConstants.TOP_LEFT_ANCHOR);
        g.drawString(String.valueOf(free), 240, 30, GameConstants.TOP_RIGHT_ANCHOR);
        g.drawString("use:", 90, 50, GameConstants.TOP_LEFT_ANCHOR);
        g.drawString(String.valueOf(use), 240, 50, GameConstants.TOP_RIGHT_ANCHOR);
        g.drawString("max:", 90, 70, GameConstants.TOP_LEFT_ANCHOR);
        g.drawString(String.valueOf(maxUse), 240, 70, GameConstants.TOP_RIGHT_ANCHOR);
