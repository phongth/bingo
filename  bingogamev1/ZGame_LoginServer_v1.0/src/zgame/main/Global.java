...
public class Global {
  public static boolean DEBUG_MODE;
	...
	public static Map<String, Server> serverMap = new HashMap<String, Server>(); // Lưu các game service theo id
	public static Map<String, Session> sessionMap = new HashMap<String, Session>(); // Store user session by username
	
	public static Map<String, User> userInfoCache = new HashMap<String, User>(); // Cache thông tin user by username
	public static Map<String, String> userNameByUserIdMap = new HashMap<String, String>(); // Map username by userId
	public static Map<String, Map<String, String>> friendListCache = new HashMap<String, Map<String,String>>(); // Cache user friend list by username
	public static Map<String, Map<String, String>> requestAddFriendCache = new HashMap<String, Map<String,String>>(); // cache requestAddFriend by user 
	
	public static Map<String, ImageInfo> imagesMap = new HashMap<String, ImageInfo>(); // Lưu danh sách resource client cần
	
	public static Map<String, List<ImageInfo>> avatarMap = new HashMap<String, List<ImageInfo>>();
	public static DataPackage categoryListDataPackage = new DataPackage(ProtocolConstants.ResponseHeader.AVATAR_CATEGORY_LIST_RESPONSE);
}
