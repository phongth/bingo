...
public class FriendDaoImpl extends FriendDao {
  ...
  public List<String> getFriendList(int userId) throws SQLException {
    ...
    sql.append(" WHERE ")
      .append(User_1_ID_COLUMN + " = ?")
      .append(" OR ")
      .append(User_2_ID_COLUMN + " = ?");
  ...
  public void makeFriend(int userId1, int userId2) throws SQLException {
    ...
    try {
      ...
      conn.rollback();
      log.warn("Can not create friend for: " + AuthenticateBussiness.getUsernameByUserId(userId1) + " and " + AuthenticateBussiness.getUsernameByUserId(userId2), e);
      throw e;
    } finally {
