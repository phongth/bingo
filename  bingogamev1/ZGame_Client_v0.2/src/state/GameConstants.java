...
public class GameConstants {
	...
	public static final int TOP_HCENTER_ANCHOR = Graphics.TOP | Graphics.HCENTER;
	public static final int VCENTER_LEFT_ANCHOR = Graphics.VCENTER | Graphics.LEFT;
	public static final int VCENTER_RIGHT_ANCHOR = Graphics.VCENTER | Graphics.RIGHT;
	public static final int CENTER_ANCHOR = Graphics.VCENTER | Graphics.HCENTER;
	public static final int BOTTOM_HCENTER_ANCHOR = Graphics.BOTTOM | Graphics.HCENTER;
	public static final int BOTTOM_LEFT_ANCHOR = Graphics.BOTTOM | Graphics.LEFT;
	public static final int BOTTOM_RIGHT_ANCHOR = Graphics.BOTTOM | Graphics.RIGHT;
	...
	static {
		...
		DEFAULT_MENU_STYLE.setFont(FontManager.getFont(FontManager.FONT_SIZE_8));
	...
	static {
		...
		DEFAULT_LIST_VIEW_STYLE.setTitleFont(FontManager.getFont(FontManager.FONT_SIZE_11));
	}
