...
public class DataPackage {
	...
	private byte[] data; // 4 bytes đầu là header, 4 byte tiếp theo là độ dài,
							// còn lại là data
	...
	public DataPackage(byte[] header, byte[] data) {
		...
		System.arraycopy(SerialUtil.serialNumber(data.length), 0, this.data, 4,
				4);
	...
	public void putByteArray(byte[] bytes) {
		if (data.length - putDataIndex < bytes.length + 4) {
			throw new ArrayIndexOutOfBoundsException(
					"putByteArray: No more space in data package: "
							+ putDataIndex + " / require space: "
							+ bytes.length);
		}
		putInt(bytes.length);
	...
	public void putInt(int value) {
		if (data.length - putDataIndex < 4) {
			throw new ArrayIndexOutOfBoundsException(
					"putInt: No more space in data package: " + putDataIndex);
		}
		System.arraycopy(SerialUtil.serialNumber(value), 0, data, putDataIndex,
				4);
		putDataIndex += 4;
	}
	...
	public void putDouble(double value) {
		if (data.length - putDataIndex < 12) {
			throw new ArrayIndexOutOfBoundsException(
					"putDouble : No more space in data package: "
							+ putDataIndex);
		}
	...
	public void putLong(long value) {
		if (data.length - putDataIndex < 8) {
			throw new ArrayIndexOutOfBoundsException(
					"putLong : No more space in data package: " + putDataIndex);
		}
		System.arraycopy(SerialUtil.serialNumber(value), 0, data, putDataIndex,
				8);
		putDataIndex += 8;
	...
	public void putShort(short value) {
		if (data.length - putDataIndex < 2) {
			throw new ArrayIndexOutOfBoundsException(
					"putShort : No more space in data package: " + putDataIndex);
		}
		System.arraycopy(SerialUtil.serialNumber(value), 0, data, putDataIndex,
				2);
		putDataIndex += 2;
	...
	public void putByte(byte value) {
		if (data.length - putDataIndex < 1) {
			throw new ArrayIndexOutOfBoundsException(
					"putByte : No more space in data package: " + putDataIndex);
		}
	...
	public void putString(String value) {
		...
		if (data.length - putDataIndex < byteValue.length + 4) {
			throw new ArrayIndexOutOfBoundsException(
					"putString : No more space in data package: "
							+ putDataIndex);
		}
		System.arraycopy(SerialUtil.serialNumber(byteValue.length), 0, data,
				putDataIndex, 4);
		System
				.arraycopy(byteValue, 0, data, putDataIndex + 4,
						byteValue.length);
	...
	public int nextInt() {
		if (data.length - getDataIndex < 4) {
			throw new ArrayIndexOutOfBoundsException(
					"nextInt: No more space in data package: " + getDataIndex);
		}
	...
	public long nextLong() {
		if (data.length - getDataIndex < 8) {
			throw new ArrayIndexOutOfBoundsException(
					"nextLong: No more space in data package: " + getDataIndex);
		}
	...
	public byte nextByte() {
		if (data.length - getDataIndex < 1) {
			throw new ArrayIndexOutOfBoundsException(
					"nextByte: No more space in data package: " + getDataIndex);
		}
	...
	public short nextShort() {
		if (data.length - getDataIndex < 2) {
			throw new ArrayIndexOutOfBoundsException(
					"nextShort: No more space in data package: " + getDataIndex);
		}
	...
	public String nextString() {
		...
		if (data.length - getDataIndex < len) {
			throw new ArrayIndexOutOfBoundsException(
					"nextString: No more space in data package: "
							+ getDataIndex);
		}
	...
	public double nextDouble() {
		if (data.length - getDataIndex < 12) {
			throw new ArrayIndexOutOfBoundsException(
					"nextDouble: No more space in data package: "
							+ getDataIndex);
		}
		long tmp1 = nextLong();
		int tmp2 = nextInt();
	...
	public byte[] nextByteArray() {
		...
		if (data.length - getDataIndex < len) {
			throw new ArrayIndexOutOfBoundsException(
					"nextByteArray: No more space in data package: "
							+ getDataIndex);
		}
	...
	public byte[] getAllData() {
		System.arraycopy(SerialUtil.serialNumber(putDataIndex - 8), 0, data, 4,
				4); // write the length of data to data package
