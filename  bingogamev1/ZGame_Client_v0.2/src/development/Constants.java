...
//	public static final String LOGIN_SERVER = "122.201.15.5";
	...
	public static final int DEFAULT_PROVIDER_ID = 1; // TODO: Provider mặc định ban đầu của bản client này, cần thay đổi giá trị này tùy theo đối tác
  ...
  public static int PASSWORD_MAX_LEN = 10;
	...
	static {
		...
		LIST_VIEW_STYLE.setTitleFont(FontManager.getFont(FontManager.FONT_SIZE_11));
	}
	...
	public static final String[] GAME_NAME = new String[]{"Phỏm", "Tiến lên Miền Bắc", "Cờ tướng", "Caro", "Cờ vua"};
	public static final String[] GAME_ID = new String[]{"tala", "tlmb", "cotuong", "caro", "covua"};
