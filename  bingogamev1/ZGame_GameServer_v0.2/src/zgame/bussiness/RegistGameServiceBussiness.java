...
public class RegistGameServiceBussiness {
  ...
  public static void gameServiceInfoRequest(Client client, DataPackage inputDataPackage) {
  ...
  public static void gameServiceRegistSuccess(Client client, DataPackage inputDataPackage) {
  ...
  public static void gameServiceRegistFail(Client client, DataPackage inputDataPackage) {
