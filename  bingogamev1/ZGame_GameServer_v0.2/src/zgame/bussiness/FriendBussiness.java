...
public class FriendBussiness {
  ...
  public static void onFriendListRequest(ServerConnection server, DataPackage dataPackage) {
    ...
    if (friends != null) {
      for (String friendName : friends.keySet()) {
        ...
        ServerConnection friendServer = Global.connectionMap.get(friend.getUsername());
  ...
  public static void onAddFriendSuccessFromDefaultService(DataPackage dataPackage) {
    ...
    ServerConnection fromUserServer = Global.connectionMap.get(fromUser);
  ...
  public static void onAddFriendRequestFromDefaultService(DataPackage dataPackage) {
    ...
    ServerConnection toUserServer = Global.connectionMap.get(toUser);
  ...
  public static void onFriendListResponseFromDefaultService(DataPackage dataPackage) {
    ...
    for (int i = 0; i < friendListSize; i++) {
      ...
      ServerConnection friendServer = Global.connectionMap.get(username);
      if (friendServer != null) {
    ...
    ServerConnection ownerServer = Global.connectionMap.get(owner);
    if (ownerServer == null) {
      return;
    }
